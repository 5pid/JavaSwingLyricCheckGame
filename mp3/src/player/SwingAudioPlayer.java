...
public class SwingAudioPlayer extends JFrame implements ActionListener {
	...
	public SwingAudioPlayer() {
		...
		btn_Open.setFont(new Font("Sans", Font.BOLD, 14));
		btn_Open.setIcon(iconOpen);
		
		btn_Play.setFont(new Font("Sans", Font.BOLD, 14));
		btn_Play.setIcon(iconPlay);
		btn_Play.setEnabled(false);
		
		btn_Pause.setFont(new Font("Sans", Font.BOLD, 14));
		btn_Pause.setIcon(iconPause);
		...
		panelButtons.add(btn_Open);
		panelButtons.add(btn_Play);
		panelButtons.add(btn_Pause);
